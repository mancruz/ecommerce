...
<head>
  ...
  <!-- CSS Files -->
  <link href="/res/admin/material/assets/css/material-dashboard.min.css?v=2.1.0" rel="stylesheet" />
...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('/res/admin/material/assets/img/transporte.jpg'); background-size: cover; background-position: top center;">
            ...
            <form class="form" action="/admin/login" method="post">
              <div class="card card-login card-hidden">
                <div class="card-header card-header-primary text-center">
                  ...
                  <h4>Autenticação de Usuário</h4><br>
                </div>
