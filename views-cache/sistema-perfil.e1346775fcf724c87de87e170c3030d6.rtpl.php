<?php if(!class_exists('Rain\Tpl')){exit;}?><?php if( $drawMenu["23"]['PERMISSAO_VISUALIZAR']== 'SIM' ){ ?>
...
<div class="content">
  ...
  <div class="col-md-12">
    ...
    <div class="card">
      ...
      <h4 class="card-title">Lista de Perfil</h4>
    </div>
    <div class="card-body">
      <div class="toolbar">
        <!--        Here you can write extra buttons/actions for the toolbar              -->
        <div class="text-right">
          <a class="btn btn-primary btn-round" href="/admin/sistema-perfil/create">
          ...
          <div class="row">
            <div class="col-sm-12">
              <table id="datatables" class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                ...
                <tbody>
                  <?php $counter1=-1;  if( isset($perfil) && ( is_array($perfil) || $perfil instanceof Traversable ) && sizeof($perfil) ) foreach( $perfil as $key1 => $value1 ){ $counter1++; ?>
                  <tr role="row" class="odd">
                    <td tabindex="0" class="sorting_1"><?php echo htmlspecialchars( $value1["PERFIL"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                      <td><?php echo htmlspecialchars( $value1["OBS"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td class="text-right">
                      <a href="/admin/sistema-perfil/<?php echo htmlspecialchars( $value1["COD_PERFIL"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-link btn-warning btn-just-icon edit">
                        <i class="material-icons">create</i>
                      </a>
                      <a href="/admin/sistema-perfil-acesso/<?php echo htmlspecialchars( $value1["COD_PERFIL"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-link btn-warning btn-just-icon edit">
