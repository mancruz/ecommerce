<?php if(!class_exists('Rain\Tpl')){exit;}?><?php if( $drawMenu["7"]['PERMISSAO_VISUALIZAR']== 'SIM' ){ ?>
          ...
          <div class="row">
            <div class="col-sm-12">
              <table id="datatables" class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                ...
                <tbody>
                  <?php $counter1=-1;  if( isset($clienteFornecedor) && ( is_array($clienteFornecedor) || $clienteFornecedor instanceof Traversable ) && sizeof($clienteFornecedor) ) foreach( $clienteFornecedor as $key1 => $value1 ){ $counter1++; ?>
                  <tr role="row" class="odd">
                    <td tabindex="0" class="sorting_1"><?php echo htmlspecialchars( $value1["NOME"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                      <td><?php echo htmlspecialchars( $value1["TEL_COMER"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                      <td><?php echo htmlspecialchars( $value1["TEL_CEL"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                      <td><?php echo htmlspecialchars( $value1["EMAIL"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                      <td><?php echo htmlspecialchars( $value1["STATUS"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td class="text-right">
                      <a href="/admin/cliente-fornecedor/<?php echo htmlspecialchars( $value1["COD_CLI_FORN"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-link btn-warning btn-just-icon edit">
                        <i class="material-icons">dvr</i>
                      </a>
                      <a href="#" onclick="confirmCancel('<?php echo htmlspecialchars( $value1["COD_CLI_FORN"], ENT_COMPAT, 'UTF-8', FALSE ); ?>')" class="btn btn-link btn-danger btn-just-icon remove"><i class="material-icons">close</i>
                      </a>
                    </td>
                  </tr>
                  <?php } ?>
