			...
			<div class="card">
				...
				<div class="card-body">            
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="form-group bmd-form-group">
								<label class="bmd-label bmd-label-floating"> Senha</label>
								<input
								id      ="senha"
								name    ="senha"
								type    ="password"
						...
						<div class="form-group col-md-2">
							<select id="acesso_sistema" name="acesso_sistema" class="form-control" required="true">
								<option value="" selected>Permitir acesso...</option>
						...
						<div class="form-group col-md-2">
							<select id="revogado" name="revogado" class="form-control" required="true">
								<option value="" selected>Usuário Revogado</option>
								<option value="Sim">Sim</option>
								<option value="Não">Não</option>
							</select>
						</div>
					...
					<div class="row">
						...
						<div class="form-group col-md-2">
							<select id="TIPO_SANGUE" name="TIPO_SANGUE" class="form-control" required="true">
								<option value="" selected>Tipo Sanguínio</option>
				...
				<div class="card-body"> 
					<div class="row">
						<div class="form-group col-md-3">
							<label for="cod_func">Cargo</label>
							<select
						...
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="form-group bmd-form-group">
									...
									<textarea id="obs_func" name="obs_func" class="form-control" rows="5"></textarea>
								</div>
							</div>
						</div>
					</div>
